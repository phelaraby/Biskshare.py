...
CITY_DATA = { 'chicago': 'E:/try/chicago.csv', 'Chicago': 'E:/try/chicago.csv',
             'New York': 'E:/try/new_york_city.csv', 'New york': 'E:/try/new_york_city.csv',
              'new york': 'E:/try/new_york_city.csv', 'washington': 'E:/try/washington.csv',
             'Washington': 'E:/try/washington.csv' }
...
def get_filters():
    ...
    #Initializing an empty month variable to store month choice from user
    month = ''
...
def load_data(city, month, day):
    ...
    #(((((dt.weekday_name   DOES NOT RUN in my python(3.8) so I have searched and used dt.dayofweek)))))
